            ...
            <TabsContent value="login">
              <div className="mb-4">
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2.5 border border-border rounded-xl py-2.5 text-sm font-medium bg-card hover:bg-muted/50 transition-colors"
                >
